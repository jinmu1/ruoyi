...
public class BaidieUtilsTest {
    ...
    public void testGenerateResponseJson() throws JsonProcessingException {
        ...
        String str = "{\"key1\":\"[{\\\"物料编码\\\":null,\\\"平均库存\\\":0,\\\"当月出库总量\\\":0.0,\\\"库存周转次数\\\":0,\\\"库存周转天数\\\":0,\\\"销售单价\\\":0.0}]\",\"key2\":\"[{\\\"出库日期\\\":null,\\\"订单编号\\\":null,\\\"物料编号\\\":null,\\\"物料名称\\\":null,\\\"出货数量\\\":0.0,\\\"出货单位\\\":null,\\\"销售单价\\\":0.0,\\\"托盘装件数\\\":0.0}]\"}";
        // 验证生成的 JSON 是否符合预期
