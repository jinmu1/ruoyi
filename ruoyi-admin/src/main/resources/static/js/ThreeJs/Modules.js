...
function initMat() {
    ...
    new THREE.TextureLoader().load( '.js/ThreeJs/images/plane.png', function( map ) {
        planeMat.map = map;
        planeMat.transparent = true;
        planeMat.opacity = 0.8;
        planeMat.needsUpdate = true;
    } );
    new THREE.TextureLoader().load( ".js/ThreeJs/images/rack.png", function( map ) {
        RackMat.map = map;
        RackMat.needsUpdate = true;
    } );
    new THREE.TextureLoader().load( ".js/ThreeJs/images/box.png", function( map ) {
        CargoMat.map = map;
        CargoMat.needsUpdate = true;
    } );
    new THREE.TextureLoader().load( ".js/ThreeJs/images/line.png", function( map ) {
        LineMat.map = map;
        LineMat.needsUpdate = true;
    } );
    RollTexture = new THREE.TextureLoader().load( ".js/ThreeJs/images/biaoyu.png", function( map ) {
        RollMat.map = map;
...
function addSkybox( size,scene ) {
    urls = [
        'js/ThreeJs/images/skybox/l_RT.jpg', // right
        'js/ThreeJs/images/skybox/l_LF.jpg', // left
        'js/ThreeJs/images/skybox/l_UP.jpg', // top
        'js/ThreeJs/images/skybox/l_DN.jpg', // bottom
        'js/ThreeJs/images/skybox/l_BK.jpg', // back
        'js/ThreeJs/images/skybox/l_FR.jpg'  // front
    ];
...
function addArea(x,z,width,length,scene,name,textColor,font_size,textposition) {
    ...
    new THREE.FontLoader().load('js/ThreeJs/FZYaoTi_Regular.json',function(font){
        ////加入立体文字
